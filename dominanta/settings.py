...
DATABASES = {
    'default': {
        ...
        'NAME': 'dominanta',   # Or path to database file if using sqlite3.
        'USER': 'dominanta',                      # Not used with sqlite3.
        'PASSWORD': 'dominanta',                  # Not used with sqlite3.
